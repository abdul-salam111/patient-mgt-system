...
//
//     final getAllStaffMembers = getAllStaffMembersFromJson(jsonString);

import 'dart:convert';

GetAllStaffMembers getAllStaffMembersFromJson(String str) =>
    GetAllStaffMembers.fromJson(json.decode(str));

String getAllStaffMembersToJson(GetAllStaffMembers data) =>
    json.encode(data.toJson());

class GetAllStaffMembers {
  final bool? success;
  ...
  factory GetAllStaffMembers.fromJson(Map<String, dynamic> json) =>
      GetAllStaffMembers(
