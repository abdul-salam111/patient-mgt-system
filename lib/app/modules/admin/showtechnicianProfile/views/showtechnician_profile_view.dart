...
class ShowtechnicianProfileView
    extends GetView<ShowtechnicianProfileController> {
  const ShowtechnicianProfileView({super.key});
  @override
  Widget build(BuildContext context) {
    Payload payload = Get.arguments;
    return Scaffold(
        appBar: AppBar(
          title: Text(payload.name.toString()),
          centerTitle: true,
        ),
        body: Column(
          children: [
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    CustomText(
                        text: payload.userName.toString(),
                        fontSize: 16.sp,
                        color: whitecolor,
                ...
                //             fontWeight: FontWeight.normal),
                //         CustomText(
                //             text: payload.practice!.name.toString(),
                //             fontSize: 16.sp,
                //             color: whitecolor,
                //             fontWeight: FontWeight.bold),
                //       ],
                ...
                Row(
                  ...
                  children: [
                    CustomText(
                        ...
                        fontWeight: FontWeight.normal),
                    CustomText(
                        text: payload.originalPassword.toString(),
                        fontSize: 16.sp,
                        color: whitecolor,
                        fontWeight: FontWeight.bold),
                  ],
