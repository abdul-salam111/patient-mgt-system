...
class ShowTechniciansView extends GetView<ShowTechniciansController> {
  const ShowTechniciansView({super.key});
  @override
  Widget build(BuildContext context) {
    Get.put(ShowTechniciansController());
    return Scaffold(
        body: Column(
      children: [
        Container(
                      ...
                      child: TextField(
                        onChanged: (search) {
                          controller.tempPayload.value = controller
                              .getTechnicianModel.value.payload!
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              GestureDetector(
                  onTap: () {
                    Get.toNamed(Routes.CREATE_TECHNICIAN,
        ...
        FutureBuilder(
            future: controller.showTechnicians(),
            builder: (context, AsyncSnapshot<GetTechnicianModel> snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                return const Expanded(child: ShimmerListView());
              } else if (!snapshot.hasData) {
                return const Center(
                  child: Text("No technician added yet."),
                );
              }
              return Obx(
                () => Expanded(
                            ...
                            return Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          Get.toNamed(Routes.MESSAGES,
                                              arguments: [
                                                controller.tempPayload[index].id
                                                    .toString(),
                                                controller
                                  ...
                                  .make()
                                  .onTap(() {
                                Get.toNamed(Routes.SHOWTECHNICIAN_PROFILE,
