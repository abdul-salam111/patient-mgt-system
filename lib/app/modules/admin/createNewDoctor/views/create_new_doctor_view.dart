...
class CreateNewDoctorView extends GetView<CreateNewDoctorController> {
  const CreateNewDoctorView({super.key});
  @override
          ...
          child: ListView(
            children: [
              ...
              CustomTextFieldForPatient(
                  ...
                  controller: controller.doctorNameController.value,
                  validator: Validators.validation("Doctor Name")),
              10.heightBox,
              CustomTextFieldForPatient(
                  textInputType: TextInputType.name,
                  hintText: "Username",
              ...
              Obx(
                () => TextFormField(
                  ...
                  style: TextStyle(color: textfieldgrey.withOpacity(0.7)),
                  ...
                  decoration: InputDecoration(
                    hintText: controller.dateController.value.text.isNotEmpty
                        ...
                        : "Date",
                    hintStyle: TextStyle(
                      color: textfieldgrey.withOpacity(0.7),
                      fontSize: 14.sp,
                      fontFamily: 'Inter',
                                          ...
                                          child: Column(
                                            children: List.generate(
                                              ...
                                              return Column(
                                                ...
                                                controller.selectedPractice
                                                        .value =
                                                    controller
                                                        .payload[index].name!;
                                                controller.selectedPractice_Id
                                                        .value =
                                                    controller
                                                        .payload[index].id!;
...
class BottomSheetContent extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final controller = Get.put(CreateNewDoctorController());
    return Padding(
      padding: pad20,
      child: Column(
